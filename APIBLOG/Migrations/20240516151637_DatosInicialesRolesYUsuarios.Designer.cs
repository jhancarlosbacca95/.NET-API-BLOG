...
namespace APIBLOG.Migrations
{
    ...
    [Migration("20240516151637_DatosInicialesRolesYUsuarios")]
    partial class DatosInicialesRolesYUsuarios
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APIBLOG.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdUsuario = new Guid("3b39c206-79b2-4613-80fc-b7bbf54c585f"),
                            Contraseña = "AdminPass123",
                            CorreoElectronico = "admin@example.com",
                            FechaRegistro = new DateTime(2024, 5, 16, 10, 16, 36, 639, DateTimeKind.Local).AddTicks(3097),
                            IdRol = 1,
                            NombreUsuario = "admin_user"
                        },
                        new
                        {
                            IdUsuario = new Guid("210396a8-904d-4646-b078-25fbe622ce74"),
                            Contraseña = "SuperAdminPass123",
                            CorreoElectronico = "superadmin@example.com",
                            FechaRegistro = new DateTime(2024, 5, 16, 10, 16, 36, 639, DateTimeKind.Local).AddTicks(3116),
                            IdRol = 2,
                            NombreUsuario = "superadmin_user"
                        },
                        new
                        {
                            IdUsuario = new Guid("f43f0bac-af76-497b-a50f-f08572d5c288"),
                            Contraseña = "UserPass123",
                            CorreoElectronico = "usuario@example.com",
                            FechaRegistro = new DateTime(2024, 5, 16, 10, 16, 36, 639, DateTimeKind.Local).AddTicks(3119),
                            IdRol = 3,
