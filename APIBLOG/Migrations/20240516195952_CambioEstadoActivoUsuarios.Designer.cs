...
namespace APIBLOG.Migrations
{
    ...
    [Migration("20240516195952_CambioEstadoActivoUsuarios")]
    partial class CambioEstadoActivoUsuarios
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APIBLOG.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdUsuario = new Guid("a2776971-466c-4438-8112-528ef4339587"),
                            Activo = true,
                            Contraseña = "AdminPass123",
                            CorreoElectronico = "admin@example.com",
                            FechaRegistro = new DateTime(2024, 5, 16, 14, 59, 51, 844, DateTimeKind.Local).AddTicks(9707),
                            IdRol = 1,
                            NombreUsuario = "admin_user"
                        },
                        new
                        {
                            IdUsuario = new Guid("6a45909a-e090-4289-a29b-4c10c31fe5ce"),
                            Activo = true,
                            Contraseña = "SuperAdminPass123",
                            CorreoElectronico = "superadmin@example.com",
                            FechaRegistro = new DateTime(2024, 5, 16, 14, 59, 51, 844, DateTimeKind.Local).AddTicks(9724),
                            IdRol = 2,
                            NombreUsuario = "superadmin_user"
                        },
                        new
                        {
                            IdUsuario = new Guid("14defdf7-dd32-42e4-a67b-0bd5d11f35d9"),
                            Activo = true,
                            Contraseña = "UserPass123",
                            CorreoElectronico = "usuario@example.com",
                            FechaRegistro = new DateTime(2024, 5, 16, 14, 59, 51, 844, DateTimeKind.Local).AddTicks(9729),
                            IdRol = 3,
